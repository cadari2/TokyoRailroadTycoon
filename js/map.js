...
function generateMap(seed, campaign) {
  ...
  //    (castle moat) — the visible moat sits at the edge of the national-land
  //    footprint (CFG.LAND.palaceRadius; v0.5.9: radius 2, so the palace hex
  //    plus its 6 grounds hexes — 7 hexes — sit inside the moat).
  ...
  // (anchored off CFG.LAND.palaceRadius so it tracks the palace footprint)
